...
<header class="s-header">
    ...
    <div class="s-header__content">
        ...
        <a href="mailto:hello@sipcreativegalaxy.co.ke" class="btn btn--primary btn--small">
    ...
    <div class="row clients-outer">
        <div class="column">
            <div class="clients" data-aos="fade-up">
                ...
                <a href="#0" title="" class="clients__slide"><img src="{{ asset('images/avatars/thefoundry.jpg') }}" /></a>
            </div> <!-- end clients -->
        </div> <!-- end column -->
